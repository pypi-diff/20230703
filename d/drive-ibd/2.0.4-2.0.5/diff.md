# Comparing `tmp/drive_ibd-2.0.4.tar.gz` & `tmp/drive_ibd-2.0.5.tar.gz`
...
### Comparing `drive_ibd-2.0.4/drive/plugins/network_writer.py` & `drive_ibd-2.0.5/drive/plugins/network_writer.py`
