# Comparing `tmp/easier-1.3.3.tar.gz` & `tmp/easier-1.3.4.tar.gz`
...
### Comparing `easier-1.3.3/LICENSE` & `easier-1.3.4/LICENSE`
...
### Comparing `easier-1.3.3/easier/clock.py` & `easier-1.3.4/easier/clock.py`
