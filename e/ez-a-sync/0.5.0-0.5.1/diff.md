# Comparing `tmp/ez-a-sync-0.5.0.tar.gz` & `tmp/ez-a-sync-0.5.1.tar.gz`
...
### Comparing `ez-a-sync-0.5.0/tests/test_decorator.py` & `ez-a-sync-0.5.1/tests/test_decorator.py`
