# Comparing `tmp/lokzzpylib-0.2.dev7.tar.gz` & `tmp/lokzzpylib-0.2.dev8.tar.gz`
...
## Comparing `lokzzpylib-0.2.dev7.tar` & `lokzzpylib-0.2.dev8.tar`
...
### Comparing `lokzzpylib-0.2.dev7/.github/workflows/python-publish.yml` & `lokzzpylib-0.2.dev8/.github/workflows/python-publish.yml`

 * *Files identical despite different names*

### Comparing `lokzzpylib-0.2.dev7/lokzzpylib/__init__.py` & `lokzzpylib-0.2.dev8/lokzzpylib/__init__.py`
...
### Comparing `lokzzpylib-0.2.dev7/pyproject.toml` & `lokzzpylib-0.2.dev8/pyproject.toml`
