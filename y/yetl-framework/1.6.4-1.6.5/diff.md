# Comparing `tmp/yetl-framework-1.6.4.tar.gz` & `tmp/yetl-framework-1.6.5.tar.gz`
...
### Comparing `yetl-framework-1.6.4/yetl/config/_tables.py` & `yetl-framework-1.6.5/yetl/config/_tables.py`
